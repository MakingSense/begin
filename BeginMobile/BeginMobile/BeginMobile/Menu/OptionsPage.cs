            ...
            var listViewMenuOptionsLogoutOnly = new ListView
                                                {
                                                    ...
                                                    ItemTemplate = dataTemplateMenuOptions,
                                                    BackgroundColor = BeginApplication.Styles.MenuBackground,
                                                    HeightRequest = BeginApplication.Styles.RowSpaceMenuItemLogout,
                                                    HasUnevenRows = true,
                                                };
            ...
            listViewMenuOptions.ItemSelected += async (sender, eventArgs) =>
                                                      {
                                                          ...
                                                          switch (selectedItemOptionName)
                                                          {
                                                                  ...
                                                                  using (
                                                                      var contentPageGroupListPage =
                                                                          new GroupListPage(
                                                                              ...
                                                                              {
                                                                                  Text =
                                                                                      MenuItemsNames.AppHomeChildGroups,
                                                                                  Style =
                                                                                      BeginApplication.Styles
                                                                                      .StyleNavigationTitle,
                                                                                  TextColor = Color.FromHex("FFFFFF")
                                                                              }.Text,
                                                                              "padlock.png"))
                                                                  {
                                                              ...
                                                              case MenuItemsNames.AppHomeServices:
                                                                  await
                                                                      DisplayAlert("Services", "Goes to services", "Ok");
                                                                  break;
            ...
            var labelOptionName = new Label
                                  {
                                      ...
                                      FontSize = BeginApplication.Styles.MenuItemFontSize
                                  };
